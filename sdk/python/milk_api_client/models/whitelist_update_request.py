...
class WhitelistUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    ip_cidr: Optional[StrictStr] = Field(default=None, alias="ipCidr")
    action: Optional[StrictStr] = None
    reason: Optional[StrictStr] = None
    added_by: Optional[StrictStr] = Field(default=None, alias="addedBy")
    expires_at: Optional[datetime] = Field(default=None, alias="expiresAt")
    __properties: ClassVar[List[str]] = ["ipCidr", "action", "reason", "addedBy", "expiresAt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ip_cidr (nullable) is None
        # and model_fields_set contains the field
        if self.ip_cidr is None and "ip_cidr" in self.model_fields_set:
            _dict['ipCidr'] = None
