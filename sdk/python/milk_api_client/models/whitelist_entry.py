...
class WhitelistEntry(BaseModel):
    ...
    ip_cidr: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="ipCidr")
    ...
    __properties: ClassVar[List[str]] = ["id", "routeId", "ipCidr", "reason", "addedBy", "addedAt", "expiresAt"]
