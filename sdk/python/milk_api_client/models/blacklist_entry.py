...
class BlacklistEntry(BaseModel):
    ...
    ip_or_cidr: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="ipOrCidr")
    ...
    __properties: ClassVar[List[str]] = ["id", "ipOrCidr", "reason", "addedBy", "addedAt", "expiresAt"]
